...
class QuickUsbWindows extends _QuickUsbDesktop {
  ...
  static registerWith() {
    AeFlutterUsbPlatform.instance = QuickUsbWindows();
    _libusb = Libusb(DynamicLibrary.open('libusb-1.0.26.dll'));
  }
}
...
class QuickUsbMacos extends _QuickUsbDesktop {
  // For example/.dart_tool/flutter_build/generated_main.dart
  static registerWith() {
    AeFlutterUsbPlatform.instance = QuickUsbMacos();
